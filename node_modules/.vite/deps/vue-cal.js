...
var St = Xe.reduce((p, t, i) => (p[t] = i || 7, p), {});
var Ct = (p, t, i) => {
  const { dateUtils: o } = p, w = false, b = computed(() => {
  ...
  }), N = computed(() => t.sm && !t.xs), d = computed(() => t.xs || t.datePicker), H = computed(() => t.clickToNavigate || t.datePicker && t.clickToNavigate !== false), v = computed(() => {
    const g = {
      cell: {},
    ...
    var _;
    const g = {};
    return t.hideWeekends && (g[6] = true) && (g[7] = true), (_ = t.hideWeekdays) != null && _.length && t.hideWeekdays.forEach((j) => g[St[j]] = true), g;
  }), h = computed(() => t.hideWeekends || u.value[6] && u.value[7]), P = computed(() => {
  ...
  }), I = computed(() => t.datePicker ? "month" : P.value.week ? "week" : Object.keys(P.value)[0]), a = computed(() => {
    ...
    return t.editableEvents === true ? g : t.editableEvents === false ? Object.keys(g).map((_) => g[_] = false) : { ...g, ...t.editableEvents };
  }), F = computed(() => {
    const { view: g } = p, { eventCount: _ } = t;
    return (Array.isArray(_) ? _.includes(g.id) : _) && (g.isMonth && !t.eventsOnMonthView || g.isYear);
  }), G = computed(() => t.allDayEvents && t.time !== false && !b.isMonth), m = computed(() => t.timeAtCursor && t.time !== false), f = async (g) => {
    var j;
    let _ = Object.assign({ "../i18n/ar.json": () => import("./ar-DVKABP4E.js").then((s) => s.default), "../i18n/bg.json": () => import("./bg-LJBMZPRX.js").then((s) => s.default), "../i18n/bn.json": () => import("./bn-5ORGA2PD.js").then((s) => s.default), "../i18n/bs.json": () => import("./bs-HA7QH5ZV.js").then((s) => s.default), "../i18n/ca.json": () => import("./ca-OGCM76D6.js").then((s) => s.default), "../i18n/cs.json": () => import("./cs-DRC54HYD.js").then((s) => s.default), "../i18n/da.json": () => import("./da-VPN6WU5A.js").then((s) => s.default), "../i18n/de.json": () => import("./de-H43F4TU2.js").then((s) => s.default), "../i18n/el.json": () => import("./el-QSZD233S.js").then((s) => s.default), "../i18n/en-gb.json": () => import("./en-gb-EXOJD2BA.js").then((s) => s.default), "../i18n/en-us.json": () => Promise.resolve().then(() => Lt).then((s) => s.default), "../i18n/es.json": () => import("./es-JG3TAGDE.js").then((s) => s.default), "../i18n/et.json": () => import("./et-ZNWXPWSS.js").then((s) => s.default), "../i18n/fa.json": () => import("./fa-PEEG25GG.js").then((s) => s.default), "../i18n/fi.json": () => import("./fi-47K7PC4W.js").then((s) => s.default), "../i18n/fr.json": () => import("./fr-WSU3AKRF.js").then((s) => s.default), "../i18n/he.json": () => import("./he-AHQ6YLUC.js").then((s) => s.default), "../i18n/hr.json": () => import("./hr-54VG7PXN.js").then((s) => s.default), "../i18n/hu.json": () => import("./hu-UFLYYLUD.js").then((s) => s.default), "../i18n/id.json": () => import("./id-3W5BH5IK.js").then((s) => s.default), "../i18n/is.json": () => import("./is-SO27VMAY.js").then((s) => s.default), "../i18n/it.json": () => import("./it-ZW44HE2Q.js").then((s) => s.default), "../i18n/ja.json": () => import("./ja-RUZ44I5K.js").then((s) => s.default), "../i18n/ka.json": () => import("./ka-IDKASSEV.js").then((s) => s.default), "../i18n/ko.json": () => import("./ko-FUGX4X2G.js").then((s) => s.default), "../i18n/lt.json": () => import("./lt-OC3HGBQT.js").then((s) => s.default), "../i18n/mn.json": () => import("./mn-VI2L4KXS.js").then((s) => s.default), "../i18n/nl.json": () => import("./nl-ODJ4HRVZ.js").then((s) => s.default), "../i18n/no.json": () => import("./no-MRG4QZR6.js").then((s) => s.default), "../i18n/pl.json": () => import("./pl-22YCWVWN.js").then((s) => s.default), "../i18n/pt-br.json": () => import("./pt-br-RR4H3HP6.js").then((s) => s.default), "../i18n/pt-pt.json": () => import("./pt-pt-MVFVXWYH.js").then((s) => s.default), "../i18n/ro.json": () => import("./ro-CV442BMP.js").then((s) => s.default), "../i18n/ru.json": () => import("./ru-3PTJE6NK.js").then((s) => s.default), "../i18n/sk.json": () => import("./sk-QNI5L5YI.js").then((s) => s.default), "../i18n/sl.json": () => import("./sl-PW2JDUBV.js").then((s) => s.default), "../i18n/sq.json": () => import("./sq-XULXTYAQ.js").then((s) => s.default), "../i18n/sr.json": () => import("./sr-PTDDKOR4.js").then((s) => s.default), "../i18n/sv.json": () => import("./sv-745DBMAH.js").then((s) => s.default), "../i18n/tr.json": () => import("./tr-2F4HHRIJ.js").then((s) => s.default), "../i18n/uk.json": () => import("./uk-ESPGLSWS.js").then((s) => s.default), "../i18n/vi.json": () => import("./vi-AAKILGJF.js").then((s) => s.default), "../i18n/zh-cn.json": () => import("./zh-cn-7MXHGAC7.js").then((s) => s.default), "../i18n/zh-hk.json": () => import("./zh-hk-4OTV7I7Y.js").then((s) => s.default) });
    {
      if (!_[`../i18n/${g}.json`]) {
  ...
  return watch(() => t.events, (g) => L.splice(0, L.length, ...g)), watch(() => t.locale, (g) => f(g || "en-us")), (t.locale || !p.texts.today) && f(t.locale || "en-us"), {
    ...toRefs(t),
    events: L,
...
var Ie = reactive({ id: null, date: null });
var nt = false;
var qe = true;
var ke = reactive({ el: null, cell: null, timeout: null });
var $e = reactive({
  eventId: null,
  fromVueCal: null,
  toVueCal: null
...
function Vt(p) {
  ...
  return {
    eventDragStart: (e, k) => {
      ...
      }, 0), nt = false, Object.assign(Ie, { id: i.id, date: i.firstCellDate }), qe = true, p.touch.isDraggingEvent = true;
    },
    eventDragEnd: (e, k) => {
      ...
      M && c !== M && o.deleteEvent(k._.id, 3), nt && qe && Ie.id && i.switchView(Ie.id, Ie.date, true), w("event-drag-end", {
        e,
        event: k,
        external: $e.fromVueCal !== b
      }), $e.fromVueCal = null, $e.toVueCal = null, p.touch.isDraggingEvent = false;
    },
    cellDragEnter: (e, k) => {
      const { start: c } = k, M = e.currentTarget;
      if (!e.currentTarget.contains(e.relatedTarget)) {
        if (M === ke.el || !M.className.includes("vuecal__cell-content")) return false;
        ke.el && (ke.cell.highlighted = false), Object.assign(ke, { el: M, cell: k, timeout: clearTimeout(ke.timeout) }), k.highlighted = true, ["years", "year", "month"].includes(i.id) && (ke.timeout = setTimeout(() => p.switchToNarrowerView(c), 2e3));
      }
    },
    cellDragOver: (e, k) => {
      const { start: c, schedule: M } = k;
      e.preventDefault(), k.highlighted = true, (M || M === 0) && (k.highlightedSchedule = M);
    },
    cellDragLeave: (e, k) => {
      e.preventDefault(), !e.currentTarget.contains(e.relatedTarget) && (k.highlightedSchedule = false, ke.cell === k && (clearTimeout(ke.timeout), Object.assign(ke, { el: null, cell: null, timeout: null }), k.highlighted = false));
    },
    cellDragDrop: async (e, k, c = false) => {
      var j, s, A;
      ...
      $e.fromVueCal === b ? (F = o.getEvent(M._.id), F && (F._.dragging = false, L = (X) => {
      ...
      _ && (g = await _({
        ...
        cell: k,
        external: $e.fromVueCal !== b
      })), g !== false && L(g), k.highlighted = false, k.highlightedSchedule = null, qe = false, $e.toVueCal = b, w("event-dropped", {
        e,
        cell: k,
        event: F,
        originalEvent: M,
...
var Ot = (p) => {
  ...
  const w = computed(() => {
    ...
    a._ || (a._ = {}), a._.id = a._.id || ++o, a.delete || (a.delete = (l) => u(a._.id, l)), a._.deleting = false, a._.deleted = false, a.isOverlapping = (l = null) => a.getOverlappingEvents(l).length, a.getOverlappingEvents = (l = null) => {
      var e;
      return P(
    ...
    return i.snapToInterval && (t.snapToInterval(a.start, i.snapToInterval), t.snapToInterval(a.end, i.snapToInterval)), a = { ...a }, a._ || (a._ = {}), a._.id = ++o, a._.fireCreated = true, i.events.push(a), a;
  }, u = async (a, l = 0) => {
    var F, G;
    ...
    const M = i.events[c];
    if (M.deletable === false) return console.warn(`Vue Cal: Can't delete event \`${e}\` since it was explicitely set to \`delete: false\`.`);
    switch (l) {
      case 0:
        M._.deleting ? i.events.splice(c, 1) : M._.deleting = true;
        break;
      ...
      case 2:
        M._.deleted = true, i.events[c]._.deleted = true, (G = M._.$el) == null || G.dispatchEvent(new CustomEvent("event-deleted", { detail: M._.id }));
        break;
    ...
    const k = i.allDayEvents ? { allDay: e } : {}, c = P(a, l, { background: false, ...k });
  ...
  }, P = (a, l, { excludeIds: e = [], schedule: k = null, background: c = true, allDay: M = false } = {}) => {
        ...
        if (oe)
          for (const n in oe) {
            ...
            for (let q = 0; q < D.length; q++) {
              ...
              !K || A.has(K._.id) || k !== null && k !== K.schedule || c === false && K.background || i.allDayEvents && (M && !K.allDay || !M && K.allDay) || K.end.getTime() > _ && K.start.getTime() < j && s.push(K);
            }
          }
      }
    }
...
var jt = ({ config: p, dateUtils: t, emit: i, texts: o, eventsManager: w }, b) => {
  const { availableViews: N } = p, d = ref(p.view && N[p.view] ? p.view : p.defaultView), H = ref(p.selectedDate || null), v = ref(/* @__PURE__ */ new Date()), u = ref(new Date(p.viewDate || v.value));
  u.value.setHours(0, 0, 0, 0);
  const h = ref(new Date(u));
  let P = null;
  const I = computed(() => d.value === "month" ? h.value : f.value), a = computed(() => d.value === "month" ? new Date(h.value.getFullYear(), h.value.getMonth() + 1, 0, 23, 59, 59, 999) : g.value), l = computed(() => d.value === "week" ? t.getPreviousFirstDayOfWeek(f.value, p.startWeekOnSunday) : d.value === "month" ? f.value : I.value), e = computed(() => {
    if (d.value === "week") {
  ...
  const F = computed(() => {
  ...
  }), m = computed(() => F.value * G.value), f = computed(() => {
    if (d.value === "month") {
    ...
    return y;
  }), g = computed(() => L.value[L.value.length - 1].end), _ = ref("right"), j = computed(() => {
  ...
  const ae = computed(() => {
    const { dateFormat: y, months: R, monthsGenitive: x, week: Q, truncations: fe } = o, Ae = p.locale, Ve = fe !== false, Me = y.indexOf("M") < y.indexOf("D"), Ye = x && Ae === "el" ? x : R;
    switch (d.value) {
      case "day":
  ...
  function De(y) {
    !y && !h.value.getDay() ? q(t.addDays(h.value, 1), true, true) : (_.value = "left", se());
  }
  function r(y) {
    y && p.startWeekOnSunday && !h.value.getDay() ? q(t.addDays(h.value, 1), true, true) : !y && p.startWeekOnSunday && h.value.getDay() === 1 && q(t.subtractDays(h.value, 1), true, true);
  }
  function E() {
  ...
  const J = computed(() => w.getViewEvents(L.value)), re = w.createEvent, we = w.deleteEvent;
  return watch(() => p.view, (y) => Z(y, false)), watch(() => p.availableViews, de), watch(() => p.datePicker, () => Z("month", false)), watch(() => p.viewDate, (y) => q(y, false)), watch(() => p.selectedDate, (y) => K(y, false)), watch(() => p.startWeekOnSunday, (y) => De(y)), watch(() => p.hideWeekends, (y) => r(y)), watch(() => p.hideWeekdays, E), watch(() => m.value, () => {
    m.value > 90 && console.warn("Vue Cal: high cell count detected. Performance may degrade when interactions are enabled.");
  }), watch(() => p.watchRealTime, (y) => {
    y && p.time ? M() : P = clearTimeout(P);
  }), se(), p.time && p.watchRealTime && M(), onBeforeUnmount(() => P = clearTimeout(P)), {
    now: v,
    id: d,
    broaderView: j,
    narrowerView: s,
...
var rt = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
...
var yt = "All-day";
var ht = "Delete";
var Dt = "Create an event";
var pt = "dddd, MMMM D, YYYY";
var wt = "am";
var kt = "pm";
var Qe = {
  weekDays: rt,
...
var zt = ({ props: p, emit: t, attrs: i, vuecalEl: o, uid: w }) => {
  const b = reactive({
    uid: w,
...
var Ft = { class: "vuecal__header" };
var Nt = {
  key: 0,
  class: "vuecal__views-bar"
};
var At = ["onClick", "innerHTML"];
var Bt = {
  key: 1,
  class: "vuecal__title-bar"
};
var Wt = { class: "vuecal__transition-wrap" };
var It = ["disabled", "innerHTML"];
var Rt = {
  __name: "header",
  setup(p) {
    const t = inject("vuecal"), { view: i, config: o } = t, w = () => {
      o.clickToNavigate && i.broader();
    }, b = computed(() => o.clickToNavigate ? { click: w } : {});
    return (N, d) => (openBlock(), createElementBlock("div", Ft, [
      renderSlot(N.$slots, "header", {
        view: unref(i),
        availableViews: unref(o).availableViews,
        vuecal: unref(t)
      }),
      N.$slots.header ? createCommentVNode("", true) : (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        unref(o).viewsBar ? (openBlock(), createElementBlock("div", Nt, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).availableViews, (H, v) => (openBlock(), createElementBlock("button", {
            class: normalizeClass(["vuecal__view-button", { "vuecal__view-button--active": unref(i).id === v }]),
            onClick: (u) => unref(i).switch(v),
            innerHTML: unref(t).texts[v],
            type: "button"
          }, null, 10, At))), 256))
        ])) : createCommentVNode("", true),
        unref(o).titleBar ? (openBlock(), createElementBlock("nav", Bt, [
          createBaseVNode("button", {
            class: normalizeClass(["vuecal__nav vuecal__nav--prev", { "vuecal__nav--default": !N.$slots["previous-button"] }]),
            onClick: d[0] || (d[0] = (...H) => unref(i).previous && unref(i).previous(...H)),
            type: "button"
          }, [
            renderSlot(N.$slots, "previous-button")
          ], 2),
          createBaseVNode("div", Wt, [
            createVNode(Transition, {
              name: `vuecal-slide-fade--${unref(i).transitionDirection}`
            }, {
              default: withCtx(() => [
                (openBlock(), createElementBlock("div", {
                  key: unref(i).id + unref(i).start.getTime()
                }, [
                  N.$slots.title || N.$slots[`title.${unref(i).id}`] ? (openBlock(), createBlock(resolveDynamicComponent(unref(o).clickToNavigate && unref(i).broaderView ? "button" : "div"), mergeProps({
                    key: 0,
                    class: "vuecal__title"
                  }, toHandlers(b.value)), {
                    default: withCtx(() => [
                      N.$slots[`title.${unref(i).id}`] ? renderSlot(N.$slots, `title.${unref(i).id}`, normalizeProps(mergeProps({ key: 0 }, unref(i)))) : renderSlot(N.$slots, "title", normalizeProps(mergeProps({ key: 1 }, unref(i))))
                    ]),
                    _: 3
                  }, 16)) : (openBlock(), createBlock(resolveDynamicComponent(unref(o).clickToNavigate && unref(i).broaderView ? "button" : "div"), mergeProps({
                    key: 1,
                    class: "vuecal__title"
                  }, toHandlers(b.value), {
                    innerHTML: unref(i).title
                  }), null, 16, ["innerHTML"]))
                ]))
              ]),
              _: 3
          ...
          unref(o).todayButton ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            N.$slots["today-button"] ? renderSlot(N.$slots, "today-button", {
              key: 0,
              navigate: () => !unref(i).containsToday && unref(i).goToToday(),
              active: unref(i).containsToday
            }) : (openBlock(), createElementBlock("button", {
              key: 1,
              class: normalizeClass(["vuecal__nav vuecal__nav--today vuecal__nav--default", { "vuecal__nav--active": unref(i).containsToday }]),
              onClick: d[1] || (d[1] = (H) => !unref(i).containsToday && unref(i).goToToday()),
              disabled: !!unref(i).containsToday,
              type: "button",
              innerHTML: unref(t).texts.today
            }, null, 10, It))
          ], 64)) : createCommentVNode("", true),
          createBaseVNode("button", {
            class: normalizeClass(["vuecal__nav vuecal__nav--next", { "vuecal__nav--default": !N.$slots["next-button"] }]),
            onClick: d[2] || (d[2] = (...H) => unref(i).next && unref(i).next(...H)),
            type: "button"
          }, [
            renderSlot(N.$slots, "next-button")
          ], 2)
        ])) : createCommentVNode("", true)
      ], 64))
    ]));
...
var Xt = ["draggable"];
var Gt = { class: "vuecal__event-details" };
var qt = { class: "vuecal__event-title" };
var Jt = {
  key: 0,
...
var Zt = { class: "vuecal__event-start" };
var Kt = {
  key: 1,
...
var st = {
  ...
  setup(p, { emit: t }) {
    const { config: i, view: o, dnd: w, touch: b, dateUtils: N } = inject("vuecal"), d = p, H = ref(null), v = reactive(d.event), u = reactive({
      dragging: false,
      resizing: false,
      fromResizer: false,
      ...
      schedule: null
    }), h = computed(() => i.editableEvents.drag && v.draggable !== false && !v.background), P = computed(() => o.isMonth || o.isYear || o.isYears || d.inAllDayBar ? false : i.time && i.editableEvents.resize && v.resizable !== false && !v.background);
    computed(() => i.editableEvents.delete && v.deletable !== false && !v.background);
    const I = computed(() => {
      var m, f, L, g, _;
      return {
        [`vuecal__event--${v._.id}`]: true,
        [v.class]: !!v.class,
      ...
      if (!m && !v.backgroundColor && !v.color) return false;
      const f = {
      ...
      u.startX = (((_ = m.touches) == null ? void 0 : _[0]) || m).clientX - L.left, u.startY = (((j = m.touches) == null ? void 0 : j[0]) || m).clientY - L.top, u.startPercentageX = u.startX * 100 / L.width, u.startPercentageY = u.startY * 100 / L.height, u.cellEl = H.value.closest(".vuecal__cell"), u.resizeStartDate = v.start, G(m.type === "touchstart" ? "touchmove" : "mousemove", k), G(m.type === "touchstart" ? "touchend" : "mouseup", c, { once: true }), u.holdTimer = setTimeout(() => {
        var s, A;
        u.holding = true, (A = (s = l.value).hold) == null || A.call(s, { e: m, event: v });
      }, 1e3);
    }, k = async (m) => {
      var L, g, _, j;
      const f = ((L = m.touches) == null ? void 0 : L[0]) || m;
      if (u.fromResizer && !u.resizing && (u.resizing = true, u.resizingOriginalEvent = { ...v, _: { ...v._ } }, b.isResizingEvent = true, (_ = (g = l.value)["resize-start"]) == null || _.call(g, { e: m, event: v })), u.holdTimer = clearTimeout(u.holdTimer), u.holding = false, u.cellEl) {
      ...
      if (u.fromResizer) {
        ...
        })), X !== false ? (v.start = s, v.end = A, u.resizingLastAcceptedEvent && (u.resizingLastAcceptedEvent = null)) : ae && (u.resizingLastAcceptedEvent = { ...v, _: { ...v._ } });
      }
    }, c = async (m) => {
      var f, L;
      if (u.holdTimer = clearTimeout(u.holdTimer), u.holding = false, u.resizing) {
        ...
        })), v.start = j === false ? (u.resizingLastAcceptedEvent || u.resizingOriginalEvent).start : ((f = u.resizingLastAcceptedEvent) == null ? void 0 : f.start) || g, v.end = j === false ? (u.resizingLastAcceptedEvent || u.resizingOriginalEvent).end : ((L = u.resizingLastAcceptedEvent) == null ? void 0 : L.end) || _, v._.duration < 1 && (v.start = u.resizingOriginalEvent.start, v.end = u.resizingOriginalEvent.end), b.isResizingEvent = false;
      }
      document.removeEventListener(m.type === "touchend" ? "touchmove" : "mousemove", k), u.resizing = false, u.fromResizer = false, u.dragging = false, u.startX = 0, u.startY = 0, u.moveX = 0, u.moveY = 0, u.startPercentageX = 0, u.startPercentageY = 0, u.movePercentageX = 0, u.movePercentageY = 0, u.cellEl = null, u.resizeStartDate = null, u.resizingOriginalEvent = null, u.resizingLastAcceptedEvent = null, u.schedule = null;
    }, M = (m) => {
    ...
    return onMounted(() => v._.register(H.value)), onBeforeUnmount(() => {
      v._.unregister();
      for (const { event: m, handler: f, options: L } of F)
        document.removeEventListener(m, f, L);
    }), (m, f) => (openBlock(), createElementBlock("div", mergeProps({ class: "vuecal__event" }, toHandlers(l.value, true), {
      ref_key: "eventEl",
      ref: H,
      class: I.value,
      style: a.value,
      draggable: h.value ? "true" : void 0,
      onDragstart: f[2] || (f[2] = (L) => h.value && unref(w).eventDragStart(L, v)),
      onDragend: f[3] || (f[3] = (L) => h.value && unref(w).eventDragEnd(L, v))
    }), [
      createBaseVNode("div", Gt, [
        m.$slots["event.all-day"] ? renderSlot(m.$slots, "event.all-day", {
          key: 0,
          event: v
        }) : m.$slots[`event.${unref(o).id}`] ? renderSlot(m.$slots, `event.${unref(o).id}`, {
          key: 1,
          event: v
        }) : renderSlot(m.$slots, "event", {
          key: 2,
          event: v
        }, () => [
          createBaseVNode("div", qt, toDisplayString(v.title), 1),
          unref(i).time && !p.inAllDayBar ? (openBlock(), createElementBlock("div", Jt, [
            unref(o).isMonth ? (openBlock(), createElementBlock("span", Ut, ",")) : createCommentVNode("", true),
            createBaseVNode("span", Zt, toDisplayString(v._[`startTimeFormatted${unref(i).twelveHour ? 12 : 24}`]), 1),
            unref(o).isMonth ? createCommentVNode("", true) : (openBlock(), createElementBlock("span", Kt, " - " + toDisplayString(v._[`endTimeFormatted${unref(i).twelveHour ? 12 : 24}`]), 1))
          ])) : createCommentVNode("", true),
          p.inAllDayBar ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
            key: 1,
      ...
      P.value ? (openBlock(), createElementBlock("div", {
        ...
        onDragstart: f[0] || (f[0] = withModifiers(() => {
        }, ["prevent", "stop"]))
      }, null, 32)) : createCommentVNode("", true),
      createVNode(Transition, { name: "vuecal-delete-btn" }, {
        default: withCtx(() => [
          v._.deleting ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "vuecal__event-delete",
            onClick: f[1] || (f[1] = withModifiers((L) => v.delete(3), ["stop"]))
...
var $t = {
  ...
  setup(p) {
    const t = p, i = inject("vuecal"), { view: o, config: w, dateUtils: b, eventsManager: N, dnd: d, touch: H } = i, v = computed(() => b.isToday(t.start)), u = ref(null), h = ref([]), P = ref(false), I = (r) => {
      h.value.push(r.detail), P.value = true;
    }, a = () => setTimeout(() => P.value = false, 300), l = reactive({
      dragging: false,
      holding: false,
      ...
      movePercentageY: 0,
      schedule: null
    }), e = ref(false), k = ref({ cellOverlaps: {}, longestStreak: 0 }), c = computed(() => {
    ...
    const G = computed(() => {
    ...
    }), m = computed(() => w.datePicker ? [] : N.getEventsInRange(
      t.start,
      t.end,
      { excludeIds: h.value, ...w.allDayEvents ? { allDay: t.allDay } : {} }
    )), f = computed(() => m.value.filter((r) => !r.background)), L = computed(() => {
      var r;
      ...
      return r;
    }), j = computed(() => w.showCellEventCount && f.value.length), s = computed(() => {
      var O;
    ...
    }), A = computed(() => w.minTimestamp !== null && w.minTimestamp > t.end.getTime()), X = computed(() => w.maxTimestamp && w.maxTimestamp < t.start.getTime()), ae = computed(() => {
      const { disableDays: r } = w, E = o.isYear || o.isYears;
      return r.length && r.includes(b.formatDate(t.start)) && !E ? true : A.value || X.value;
    }), se = reactive({
      show: computed(() => {
        if (!(!o.isDay && !o.isDays && !o.isWeek) && !(!v.value || !w.time || t.allDay) && !(w.timeFrom > b.dateToMinutes(o.now)) && !(b.dateToMinutes(o.now) > w.timeTo))
          return true;
      }),
      nowInMinutes: computed(() => b.dateToMinutes(o.now)),
      todaysTimePosition: computed(() => Oe(se.nowInMinutes, w)),
      style: computed(() => `top: ${se.todaysTimePosition}%`),
      currentTime: computed(() => b.formatTime(o.now))
    }), de = computed(() => {
      if (ae.value) return {};
      ...
      l.startX = (((O = r.touches) == null ? void 0 : O[0]) || r).clientX - E.left, l.startY = (((Y = r.touches) == null ? void 0 : Y[0]) || r).clientY - E.top, l.startPercentageX = l.startX * 100 / E.width, l.startPercentageY = l.startY * 100 / E.height, l.thresholdPassed = false, document.addEventListener(r.type === "touchstart" ? "touchmove" : "mousemove", $), document.addEventListener(r.type === "touchstart" ? "touchend" : "mouseup", D, { once: true }), l.holdTimer = setTimeout(() => {
        var B, J;
        l.holding = true, (J = (B = de.value).hold) == null || J.call(B, { e: r, cell: Z.value, cursor: ee.value });
      }, 1e3);
    }, $ = (r) => {
      var O, Y, B, J, re, we;
      l.dragging || (H.isDraggingCell = true, (Y = (O = de.value)["drag-start"]) == null || Y.call(O, { e: r, cell: Z.value, cursor: ee.value })), l.dragging = true, l.holdTimer = clearTimeout(l.holdTimer), l.holding = false;
      const E = u.value.getBoundingClientRect();
      l.moveX = (((B = r.touches) == null ? void 0 : B[0]) || r).clientX - E.left, l.moveY = (((J = r.touches) == null ? void 0 : J[0]) || r).clientY - E.top, l.movePercentageX = l.moveX * 100 / E.width, l.movePercentageY = l.moveY * 100 / E.height, w.eventCreateMinDrag && Math.abs(l.startY - l.moveY) > w.eventCreateMinDrag && (l.thresholdPassed = true), (we = (re = de.value).drag) == null || we.call(re, { e: r, cell: Z.value, cursor: ee.value });
    }, D = async (r) => {
      var E, O;
      document.removeEventListener(r.type === "touchend" ? "touchmove" : "mousemove", $, { passive: false }), l.dragging && ((O = (E = de.value)["drag-end"]) == null || O.call(E, { e: r, cell: Z.value, cursor: ee.value }), H.isDraggingCell = false, w.editableEvents.create && (e.value = true, await q(r), e.value = false)), l.holdTimer = clearTimeout(l.holdTimer), l.holding = false, l.dragging = false, l.startX = 0, l.startY = 0, l.moveX = 0, l.moveY = 0, l.startPercentageX = 0, l.startPercentageY = 0, l.movePercentageX = 0, l.movePercentageY = 0, l.thresholdPassed = false, l.schedule = null;
    }, q = async (r) => {
      if (!M.value) return;
    ...
    return watch(
      ...
      K(), await nextTick();
    }), (r, E) => (openBlock(), createElementBlock("div", mergeProps({
      class: ["vuecal__cell", F.value],
      ref_key: "cellEl",
      ref: u
    }, toHandlers(de.value, true)), [
      r.$slots.cell ? renderSlot(r.$slots, "cell", {
        key: 0,
        cell: Z.value
      }) : createCommentVNode("", true),
      s.value ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(s.value, (O, Y) => (openBlock(), createElementBlock("div", {
        class: normalizeClass(["vuecal__special-hours", O.class]),
        style: normalizeStyle(O.style),
        innerHTML: O.label || ""
      }, null, 14, xt))), 256)) : createCommentVNode("", true),
      !r.$slots.cell && unref(w).schedules ? (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(unref(w).schedules, (O) => (openBlock(), createElementBlock("div", {
        class: normalizeClass(["vuecal__schedule vuecal__schedule--cell", O.class]),
        key: O.id,
        style: normalizeStyle(O.style || null),
        "data-schedule": O.id
      }, [
        r.$slots["cell-events"] ? renderSlot(r.$slots, "cell-events", {
          key: 0,
          cell: Z.value
        }) : createCommentVNode("", true),
        G.value || r.$slots["cell-date"] ? (openBlock(), createElementBlock("div", ta, [
          renderSlot(r.$slots, "cell-date", { cell: Z.value }, () => [
            createTextVNode(toDisplayString(G.value), 1)
          ])
        ])) : createCommentVNode("", true),
        r.$slots["cell-content"] ? (openBlock(), createElementBlock("div", aa, [
          renderSlot(r.$slots, "cell-content", { cell: Z.value })
        ])) : createCommentVNode("", true),
        r.$slots["cell-events"] && m.value.length ? (openBlock(), createElementBlock("div", na, [
          renderSlot(r.$slots, "cell-events", { cell: Z.value })
        ])) : m.value.length || P.value ? (openBlock(), createBlock(TransitionGroup, {
          key: 4,
          class: "vuecal__cell-events",
          name: "vuecal-event-delete",
          onBeforeLeave: E[0] || (E[0] = (Y) => P.value = true),
          onAfterLeave: a,
          tag: "div"
        }, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(L.value[O.id], (Y) => (openBlock(), createBlock(st, {
              key: Y._.id,
              event: Y,
              onEventDeleted: I,
              "in-all-day-bar": t.allDay,
              style: normalizeStyle(g.value[Y._.id])
            }, createSlots({ _: 2 }, [
              r.$slots["event.all-day"] && t.allDay ? {
                name: "event.all-day",
                fn: withCtx((B) => [
                  renderSlot(r.$slots, "event.all-day", mergeProps({ ref_for: true }, B))
                ]),
                key: "0"
              } : void 0,
              r.$slots[`event.${unref(o).id}`] ? {
                name: `event.${unref(o).id}`,
                fn: withCtx((B) => [
                  renderSlot(r.$slots, `event.${unref(o).id}`, mergeProps({ ref_for: true }, B))
                ]),
                key: "1"
              } : void 0,
              r.$slots.event ? {
                name: "event",
                fn: withCtx((B) => [
                  renderSlot(r.$slots, "event", mergeProps({ ref_for: true }, B))
                ]),
                key: "2"
              } : void 0
        ...
        M.value && l.schedule === O.id && !t.allDay ? (openBlock(), createElementBlock("div", {
          key: 5,
          class: "vuecal__event-placeholder",
          style: normalizeStyle(c.value.style)
        }, toDisplayString(c.value.start) + " - " + toDisplayString(c.value.end), 5)) : createCommentVNode("", true)
      ], 14, ea))), 128)) : createCommentVNode("", true),
      !r.$slots.cell && !unref(w).schedules ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
        r.$slots["cell-events"] ? renderSlot(r.$slots, "cell-events", {
          key: 0,
          cell: Z.value
        }) : createCommentVNode("", true),
        G.value || r.$slots["cell-date"] ? (openBlock(), createElementBlock("div", sa, [
          renderSlot(r.$slots, "cell-date", { cell: Z.value }, () => [
            createTextVNode(toDisplayString(G.value), 1)
          ])
        ])) : createCommentVNode("", true),
        r.$slots["cell-content"] ? (openBlock(), createElementBlock("div", la, [
          renderSlot(r.$slots, "cell-content", { cell: Z.value })
        ])) : createCommentVNode("", true),
        r.$slots["cell-events"] && m.value.length ? (openBlock(), createElementBlock("div", ra, [
          renderSlot(r.$slots, "cell-events", { cell: Z.value })
        ])) : !(unref(o).isMonth && !unref(w).eventsOnMonthView) && !unref(o).isYear && !unref(o).isYears && (m.value.length || P.value) ? (openBlock(), createBlock(TransitionGroup, {
          key: 4,
          class: "vuecal__cell-events",
          name: "vuecal-event-delete",
          onBeforeLeave: E[1] || (E[1] = (O) => P.value = true),
          onAfterLeave: a,
          tag: "div"
        }, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(m.value, (O) => (openBlock(), createBlock(st, {
              key: O._.id,
              event: O,
              onEventDeleted: I,
              "in-all-day-bar": t.allDay,
              class: normalizeClass(_.value[O._.id]),
              style: normalizeStyle(g.value[O._.id])
            }, createSlots({ _: 2 }, [
              r.$slots["event.all-day"] && t.allDay ? {
                name: "event.all-day",
                fn: withCtx((Y) => [
                  renderSlot(r.$slots, "event.all-day", mergeProps({ ref_for: true }, Y))
                ]),
                key: "0"
              } : void 0,
              r.$slots[`event.${unref(o).id}`] ? {
                name: `event.${unref(o).id}`,
                fn: withCtx((Y) => [
                  renderSlot(r.$slots, `event.${unref(o).id}`, mergeProps({ ref_for: true }, Y))
                ]),
                key: "1"
              } : void 0,
              r.$slots.event ? {
                name: "event",
                fn: withCtx((Y) => [
                  renderSlot(r.$slots, "event", mergeProps({ ref_for: true }, Y))
                ]),
                key: "2"
              } : void 0
      ...
      r.$slots["event-count"] ? renderSlot(r.$slots, "event-count", {
        key: 4,
        events: f.value
      }) : j.value ? (openBlock(), createElementBlock("div", oa, toDisplayString(f.value.length), 1)) : createCommentVNode("", true),
      se.show ? (openBlock(), createElementBlock("div", {
        key: 6,
        class: "vuecal__now-line",
        style: normalizeStyle(se.style),
        title: se.currentTime
      }, [
        createBaseVNode("span", null, toDisplayString(se.currentTime), 1)
      ], 12, ia)) : createCommentVNode("", true)
    ], 16));
  }
};
var ua = {
...
var da = ["onClick"];
var va = { class: "vuecal__weekday-day" };
var fa = {
  key: 0,
...
var ha = {
  __name: "headings-bar",
  setup(p) {
    const t = inject("vuecal"), i = inject("$vuecalEl"), { view: o, config: w, dateUtils: b } = t, N = computed(() => w.xs ? "day-xs" : w.sm || o.isDays || o.isMonth ? "day-sm" : "day"), d = computed(() => (o.isDay || o.isDays || o.isWeek || o.isMonth) && !(o.isDay && !w.schedules && !w.allDayEvents)), H = computed(() => o.cellDates.slice(0, o.cols).map(({ start: h }) => ({
      id: Xe[h.getDay()],
      date: h,
      ...
      cleanup() {
        typeof document < "u" && (document.removeEventListener("mousemove", u.handleMouseMove), document.removeEventListener("mouseup", u.cleanup), document.removeEventListener("touchmove", u.handleTouchMove, { passive: false }), document.removeEventListener("touchend", u.cleanup)), u.isResizing.value = false;
      },
      startResize(h) {
        var I;
        this.isResizing.value = true, this.startY.value = h;
        const P = (I = i.value) == null ? void 0 : I.querySelector(".vuecal__all-day");
        P && (this.initialHeight.value = P.offsetHeight), document.addEventListener("mousemove", u.handleMouseMove), document.addEventListener("mouseup", u.cleanup), document.addEventListener("touchmove", u.handleTouchMove, { passive: false }), document.addEventListener("touchend", u.cleanup);
      },
    ...
    return onBeforeUnmount(() => {
      u.cleanup();
    }), (h, P) => d.value ? (openBlock(), createElementBlock("div", ua, [
      unref(o).isDay ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", ca, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(H.value, (I, a) => (openBlock(), createElementBlock("div", {
          class: normalizeClass(["vuecal__weekday", { "vuecal__weekday--today": I.isToday }]),
          key: a,
          onClick: (l) => v.click(I.date)
        }, [
          renderSlot(h.$slots, "weekday-heading", {
            label: I[N.value],
            id: I.id,
            date: I.date
          }, () => [
            createBaseVNode("span", va, toDisplayString(I[N.value]), 1),
            unref(o).isMonth ? createCommentVNode("", true) : (openBlock(), createElementBlock("strong", fa, toDisplayString(I.dateNumber), 1))
          ])
        ], 10, da))), 128))
      ])),
      unref(w).schedules ? (openBlock(), createElementBlock("div", ma, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(H.value, (I, a) => (openBlock(), createElementBlock(Fragment, { key: a }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(w).schedules, (l, e) => (openBlock(), createElementBlock(Fragment, { key: e }, [
            h.$slots["schedule-heading"] ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass(["vuecal__schedule vuecal__schedule--heading", l.class])
            }, [
              renderSlot(h.$slots, "schedule-heading", {
                schedule: l,
                view: unref(o)
              })
      ...
      unref(w).allDayEvents ? (openBlock(), createElementBlock("div", ya, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(H.value, (I, a) => (openBlock(), createBlock($t, {
          class: normalizeClass(["vuecal__all-day-cell", { "vuecal__weekday--today": I.isToday }]),
          key: a,
          start: I.date,
          ...
          h.$slots["event.all-day"] ? {
            name: "event.all-day",
            fn: withCtx((l) => [
              renderSlot(h.$slots, "event.all-day", mergeProps({ ref_for: true }, l))
            ]),
            key: "0"
          } : {
            name: "event",
            fn: withCtx((l) => [
              renderSlot(h.$slots, "event", mergeProps({ ref_for: true }, l))
            ]),
            key: "1"
          }
...
var Da = { class: "vuecal__time-column" };
var pa = {
  key: 0,
...
var wa = {
  __name: "time-column",
  setup(p) {
    const t = inject("vuecal"), { config: i, texts: o } = t, w = computed(() => {
      const b = [];
    ...
    return (b, N) => (openBlock(), createElementBlock("div", Da, [
      unref(i).allDayEvents ? (openBlock(), createElementBlock("div", pa, [
        renderSlot(b.$slots, "all-day-label", {}, () => [
          createTextVNode(toDisplayString(unref(t).texts.allDay), 1)
        ])
      ])) : createCommentVNode("", true),
      (openBlock(true), createElementBlock(Fragment, null, renderList(w.value, (d, H) => (openBlock(), createElementBlock("div", {
        class: "vuecal__time-cell",
        key: H,
        style: normalizeStyle({ height: d.height || null })
      }, [
        renderSlot(b.$slots, "time-cell", {
          index: H,
          minutes: d.minutes,
          hours: d.hours,
          ...
          createBaseVNode("label", null, toDisplayString(unref(i).twelveHour ? d.formatted12 : d.formatted24), 1)
        ])
      ], 4))), 128))
    ]));
  }
...
var ka = {
  __name: "body",
  setup(p) {
    const t = inject("vuecal"), { view: i, config: o, dateUtils: w } = t, b = ref(null), N = ref(null), d = computed(() => ({
    ...
    return onMounted(() => {
    ...
    }), (h, P) => (openBlock(), createElementBlock("div", {
      class: "vuecal__body",
      ref_key: "bodyEl",
      ref: b,
      ...
      createVNode(Transition, { name: "vuecal-shrink" }, {
        default: withCtx(() => [
          unref(o).timeAtCursor && N.value !== null ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "vuecal__time-at-cursor",
            style: normalizeStyle(H.value.style)
          }, [
            createBaseVNode("label", null, toDisplayString(H.value.time), 1)
          ], 4)) : createCommentVNode("", true)
        ]),
        _: 1
      }),
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(i).cellDates, (I, a) => (openBlock(), createBlock($t, {
        key: a,
        start: I.start,
        end: I.end,
        index: a
        ...
        h.$slots.cell ? {
          name: "cell",
          fn: withCtx((l) => [
            renderSlot(h.$slots, "cell", mergeProps({ ref_for: true }, l))
          ]),
          key: "0"
        } : void 0,
        h.$slots["cell-date"] ? {
          name: "cell-date",
          fn: withCtx((l) => [
            renderSlot(h.$slots, "cell-date", mergeProps({ ref_for: true }, l))
          ]),
          key: "1"
        } : void 0,
        h.$slots["cell-content"] ? {
          name: "cell-content",
          fn: withCtx((l) => [
            renderSlot(h.$slots, "cell-content", mergeProps({ ref_for: true }, l))
          ]),
          key: "2"
        } : void 0,
        h.$slots["cell-events"] ? {
          name: "cell-events",
          fn: withCtx((l) => [
            renderSlot(h.$slots, "cell-events", mergeProps({ ref_for: true }, l))
          ]),
          key: "3"
        } : void 0,
        h.$slots[`event.${unref(i).id}`] ? {
          name: `event.${unref(i).id}`,
          fn: withCtx((l) => [
            renderSlot(h.$slots, `event.${unref(i).id}`, mergeProps({ ref_for: true }, l))
          ]),
          key: "4"
        } : void 0,
        h.$slots["event.all-day"] ? {
        ...
        h.$slots["event-count"] ? {
          name: "event-count",
          fn: withCtx((l) => [
            renderSlot(h.$slots, "event-count", mergeProps({ ref_for: true }, l))
          ]),
          key: "7"
        } : void 0
...
var $a = ["data-locale"];
var _a = { class: "vuecal__scrollable-wrap" };
var ba = {
  key: 1,
  class: "vuecal__week-numbers"
};
var Ta = { class: "vuecal__week-number" };
var Ma = { class: "vuecal__body-wrap" };
var Ea = {
  __name: "index",
  props: Pt,
  emits: [
  ...
  setup(p, { expose: t, emit: i }) {
    const o = p, w = i, b = useTemplateRef("vuecal-el"), N = zt({ props: o, emit: w, attrs: useAttrs(), vuecalEl: b, uid: useId() }), { config: d, view: H, dateUtils: v, touch: u } = N, h = computed(() => d.time && (H.isDay || H.isDays || H.isWeek)), P = computed(() => Array(H.rows).fill().map((e, k) => v.getWeek(v.addDays(H.firstCellDate, 7 * k)))), I = computed(() => {
      var e;
      return {
      ...
      return {
        ...
        [`vuecal__scrollable--${H.id}-view`]: true,
    ...
    return onMounted(async () => {
      await nextTick(), d.ready = true, w("ready", { config: d, view: H });
    }), provide("vuecal", N), provide("$vuecalEl", b), t({ view: N.view }), (e, k) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(["vuecal", I.value]),
      ref: "vuecal-el",
      "data-locale": e.locale,
      style: normalizeStyle(a.value)
    }, [
      e.$slots.diy ? renderSlot(e.$slots, "diy", {
        key: 0,
        vuecal: unref(N)
      }) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        createVNode(Rt, null, createSlots({ _: 2 }, [
          e.$slots.header ? {
            name: "header",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "header", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "0"
          } : void 0,
          !e.$slots.header && e.$slots["previous-button"] ? {
            ...
            fn: withCtx((c) => [
              renderSlot(e.$slots, "previous-button", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "1"
          } : void 0,
          !e.$slots.header && e.$slots["next-button"] ? {
            name: "next-button",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "next-button", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "2"
          } : void 0,
          !e.$slots.header && e.$slots["today-button"] ? {
            name: "today-button",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "today-button", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "3"
          } : void 0,
          !e.$slots.header && e.$slots.title ? {
            name: "title",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "4"
          } : void 0,
          !e.$slots.header && e.$slots["title.day"] ? {
            name: "title.day",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title.day", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "5"
          } : void 0,
          !e.$slots.header && e.$slots["title.days"] ? {
            name: "title.days",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title.days", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "6"
          } : void 0,
          !e.$slots.header && e.$slots["title.week"] ? {
            name: "title.week",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title.week", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "7"
          } : void 0,
          !e.$slots.header && e.$slots["title.month"] ? {
            name: "title.month",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title.month", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "8"
          } : void 0,
          !e.$slots.header && e.$slots["title.year"] ? {
            name: "title.year",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title.year", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "9"
          } : void 0,
          !e.$slots.header && e.$slots["title.years"] ? {
            name: "title.years",
            fn: withCtx((c) => [
              renderSlot(e.$slots, "title.years", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "10"
          } : void 0,
          !e.$slots.header && e.$slots["schedule-heading"] ? {
            ...
            fn: withCtx((c) => [
              renderSlot(e.$slots, "schedule-heading", normalizeProps(guardReactiveProps(c)))
            ]),
            key: "11"
          } : void 0
        ]), 1024),
        createBaseVNode("div", _a, [
          createVNode(Transition, {
            name: `vuecal-slide-fade--${unref(H).transitionDirection}`
          }, {
            default: withCtx(() => [
              (openBlock(), createElementBlock("div", {
                class: normalizeClass(["vuecal__scrollable", l.value]),
                key: unref(H).id + unref(H).start.getTime()
              }, [
                h.value ? (openBlock(), createBlock(wa, { key: 0 }, createSlots({ _: 2 }, [
                  e.$slots["time-cell"] ? {
                    name: "time-cell",
                    fn: withCtx((c) => [
                      renderSlot(e.$slots, "time-cell", normalizeProps(guardReactiveProps(c)))
                    ]),
                    key: "0"
                  } : void 0
                ]), 1024)) : createCommentVNode("", true),
                unref(d).weekNumbers && unref(H).isMonth ? (openBlock(), createElementBlock("div", ba, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(P.value, (c) => (openBlock(), createElementBlock("div", Ta, [
                    renderSlot(e.$slots, "week-number", {}, () => [
                      createBaseVNode("small", null, toDisplayString(c), 1)
                    ])
                  ]))), 256))
                ])) : createCommentVNode("", true),
                createBaseVNode("div", Ma, [
                  createVNode(ha, null, createSlots({ _: 2 }, [
                    e.$slots["weekday-heading"] ? {
                      name: "weekday-heading",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "weekday-heading", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "0"
                    } : void 0,
                    ...
                    e.$slots["event.all-day"] ? {
                      name: "event.all-day",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "event.all-day", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "2"
                    } : void 0,
                    e.$slots.event ? {
                      name: "event",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "event", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "3"
                    } : void 0
                  ]), 1024),
                  createVNode(ka, null, createSlots({ _: 2 }, [
                    e.$slots.cell ? {
                      name: "cell",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "cell", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "0"
                    } : void 0,
                    !e.$slots.cell && e.$slots["cell-date"] ? {
                      name: "cell-date",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "cell-date", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "1"
                    } : void 0,
                    !e.$slots.cell && e.$slots["cell-content"] ? {
                      name: "cell-content",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "cell-content", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "2"
                    } : void 0,
                    !e.$slots.cell && e.$slots["cell-events"] ? {
                      name: "cell-events",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "cell-events", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "3"
                    } : void 0,
                    ...
                    !e.$slots.cell && !e.$slots["cell-events"] && e.$slots[`event.${unref(H).id}`] ? {
                      name: `event.${unref(H).id}`,
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, `event.${unref(H).id}`, normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "5"
                    } : void 0,
                    ...
                    !e.$slots.cell && e.$slots["event-count"] ? {
                      name: "event-count",
                      fn: withCtx((c) => [
                        renderSlot(e.$slots, "event-count", normalizeProps(guardReactiveProps(c)))
                      ]),
                      key: "7"
                    } : void 0
                  ]), 1024)
